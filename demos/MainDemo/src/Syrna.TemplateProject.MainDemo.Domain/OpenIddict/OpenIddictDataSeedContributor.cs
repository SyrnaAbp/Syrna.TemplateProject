...
namespace Syrna.TemplateProject.MainDemo.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("TemplateProject") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
            {
                Name = "TemplateProject",
                DisplayName = "TemplateProject API",
                Resources = { "TemplateProject" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Web Client
        var webClientId = configurationSection["TemplateProject_Web:ClientId"];
        if (!webClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["TemplateProject_Web:RootUrl"]!.EnsureEndsWith('/');

            /* TemplateProject_Web client is only needed if you created a tiered
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["TemplateProject_Web:ClientSecret"] ?? "1q2w3e*",
        ...
        var consoleAndAngularClientId = configurationSection["TemplateProject_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["TemplateProject_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
        ...
        // Blazor Client
        var blazorClientId = configurationSection["TemplateProject_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["TemplateProject_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        var blazorServerTieredClientId = configurationSection["TemplateProject_BlazorServerTiered:ClientId"];
        if (!blazorServerTieredClientId.IsNullOrWhiteSpace())
        {
            var blazorServerTieredRootUrl = configurationSection["TemplateProject_BlazorServerTiered:RootUrl"]!.EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["TemplateProject_BlazorServerTiered:ClientSecret"] ?? "1q2w3e*",
                grantTypes: [OpenIddictConstants.GrantTypes.AuthorizationCode, OpenIddictConstants.GrantTypes.Implicit],
                scopes: commonScopes,
        ...
        var blazorWebAppTieredClientId = configurationSection["TemplateProject_BlazorWebAppTiered:ClientId"];
        if (!blazorWebAppTieredClientId.IsNullOrWhiteSpace())
        {
            var blazorWebAppTieredRootUrl = configurationSection["TemplateProject_BlazorWebAppTiered:RootUrl"]!.EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["TemplateProject_BlazorWebAppTiered:ClientSecret"] ?? "1q2w3e*",
                grantTypes: [OpenIddictConstants.GrantTypes.AuthorizationCode, OpenIddictConstants.GrantTypes.Implicit],
                scopes: commonScopes,
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["TemplateProject_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["TemplateProject_Swagger:RootUrl"]?.TrimEnd('/');
